...
| 7.5+ | Extended module parser (let decls, match / lambdas / multi-line bodies, tag / trait / impl), then elaborator and codegen in ll-lang | Planned |
