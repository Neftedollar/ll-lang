...
| 7.5+ | Remaining extensions (multi-line bodies, let-in / lambdas in fn bodies, cons / list / tuple patterns, tagged literals, tag / trait / impl / import, multi-line type decls, parametric ctor args), then elaborator and codegen in ll-lang | Planned |
