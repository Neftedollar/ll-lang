...
and applyBrackTypeArgs __ll_base toks =
    (match toks with | (LBrack :: (TypeId(arg) :: (LBrack :: (TypeId(inner) :: (RBrack :: (RBrack :: rest)))))) -> ((applyBrackTypeArgs (TyApp (__ll_base, (TyApp ((TyName arg), (TyName inner)))))) rest) | (LBrack :: (TypeId(arg) :: (RBrack :: rest))) -> ((applyBrackTypeArgs (TyApp (__ll_base, (TyName arg)))) rest) | (LBrack :: (Ident(arg) :: (RBrack :: rest))) -> ((applyBrackTypeArgs (TyApp (__ll_base, (TyName arg)))) rest) | (LBrack :: rest) -> (let rest2 = (skipBrackTypeBody rest) in (__ll_base, rest2)) | _ -> (__ll_base, toks))

and parseTypeExprAtom toks =
    (match toks with | (TypeId(name) :: rest) -> ((applyBrackTypeArgs (TyName name)) rest) | (Ident(name) :: rest) -> ((TyName name), rest) | (LParen :: rest) -> (parseTypeExprParens rest) | _ -> ((TyName "?"), toks))
...
and parseReturnType toks =
    (match toks with | (TypeId(name) :: rest) -> (let (ty, rest2) = ((applyBrackTypeArgs (TyName name)) rest) in ((Some ty), rest2)) | _ -> (None, toks))

and parseParamGroups toks =
    (match toks with | (LParen :: (RParen :: rest)) -> ([], rest) | (LParen :: (Ident(pname) :: (TypeId(tname) :: rest))) -> (let (ty, rest2) = ((applyBrackTypeArgs (TyName tname)) rest) in (let rest3 = (match rest2 with | (RParen :: r) -> r | _ -> rest2) in (let (ps, rest4) = (parseParamGroups rest3) in (((MkParam (pname, ty)) :: ps), rest4)))) | (LParen :: (Underscore :: (Ident(pname) :: (TypeId(tname) :: rest)))) -> (let (ty, rest2) = ((applyBrackTypeArgs (TyName tname)) rest) in (let rest3 = (match rest2 with | (RParen :: r) -> r | _ -> rest2) in (let (ps, rest4) = (parseParamGroups rest3) in (((MkParam (((strConcat "_") pname), ty)) :: ps), rest4)))) | (LParen :: (Ident(pname) :: (RParen :: rest))) -> (let (ps, rest2) = (parseParamGroups rest) in (((MkParam (pname, (TyName "?"))) :: ps), rest2)) | _ -> ([], toks))
...
and baseEnv =
    (let e0 = typeEnvEmpty in (let e1 = (((typeEnvInsert "+") (baseScheme tyArith)) e0) in (let e2 = (((typeEnvInsert "-") (baseScheme tyArith)) e1) in (let e3 = (((typeEnvInsert "*") (baseScheme tyArith)) e2) in (let e4 = (((typeEnvInsert "/") (baseScheme tyArith)) e3) in (let e5 = (((typeEnvInsert "==") (baseScheme tyCmp)) e4) in (let e6 = (((typeEnvInsert "!=") (baseScheme tyCmp)) e5) in (let e7 = (((typeEnvInsert "<") (baseScheme tyCmp)) e6) in (let e8 = (((typeEnvInsert ">") (baseScheme tyCmp)) e7) in (let e9 = (((typeEnvInsert "<=") (baseScheme tyCmp)) e8) in (let e10 = (((typeEnvInsert ">=") (baseScheme tyCmp)) e9) in (let e11 = (((typeEnvInsert "printfn") (baseScheme (TyFn (tyStr, tyUnit)))) e10) in (let e12 = (((typeEnvInsert "intToStr") (baseScheme (TyFn (tyInt, tyStr)))) e11) in (let e13 = (((typeEnvInsert "strConcat") (baseScheme (TyFn (tyStr, (TyFn (tyStr, tyStr)))))) e12) in (let e14 = (((typeEnvInsert "strLen") (baseScheme (TyFn (tyStr, tyInt)))) e13) in (let e15 = (((typeEnvInsert "strTrim") (baseScheme (TyFn (tyStr, tyStr)))) e14) in (let e16 = (((typeEnvInsert "strContains") (baseScheme (TyFn (tyStr, (TyFn (tyStr, tyBool)))))) e15) in (let e17 = (((typeEnvInsert "strChars") (baseScheme (TyFn (tyStr, (tyList tyChar))))) e16) in (let e18 = (((typeEnvInsert "strFromChars") (baseScheme (TyFn ((tyList tyChar), tyStr)))) e17) in (let e19 = (((typeEnvInsert "strReverse") (baseScheme (TyFn (tyStr, tyStr)))) e18) in (let e20 = (((typeEnvInsert "strSlice") (baseScheme (TyFn (tyStr, (TyFn (tyInt, (TyFn (tyInt, tyStr)))))))) e19) in (let e21 = (((typeEnvInsert "strIndexOf") (baseScheme (TyFn (tyStr, (TyFn (tyStr, tyInt)))))) e20) in (let e22 = (((typeEnvInsert "strSplit") (baseScheme (TyFn (tyStr, (TyFn (tyStr, (tyList tyStr))))))) e21) in (let e23 = (((typeEnvInsert "strToInt") (baseScheme (TyFn (tyStr, tyInt)))) e22) in (let e24 = (((typeEnvInsert "charToInt") (baseScheme (TyFn (tyChar, tyInt)))) e23) in (let e25 = (((typeEnvInsert "intToChar") (baseScheme (TyFn (tyInt, tyChar)))) e24) in (let e26 = (((typeEnvInsert "charIsDigit") (baseScheme (TyFn (tyChar, tyBool)))) e25) in (let e27 = (((typeEnvInsert "charIsAlpha") (baseScheme (TyFn (tyChar, tyBool)))) e26) in (let e28 = (((typeEnvInsert "charIsSpace") (baseScheme (TyFn (tyChar, tyBool)))) e27) in (let e29 = (((typeEnvInsert "abs") (baseScheme (TyFn (tyInt, tyInt)))) e28) in (let e30 = (((typeEnvInsert "absf") (baseScheme (TyFn (tyFloat, tyFloat)))) e29) in (let e31 = (((typeEnvInsert "sqrt") (baseScheme (TyFn (tyFloat, tyFloat)))) e30) in (let e32 = (((typeEnvInsert "min") (baseScheme (TyFn (tyInt, (TyFn (tyInt, tyInt)))))) e31) in (let e33 = (((typeEnvInsert "max") (baseScheme (TyFn (tyInt, (TyFn (tyInt, tyInt)))))) e32) in (let e34 = (((typeEnvInsert "print") (baseScheme (TyFn (tyStr, tyUnit)))) e33) in (let e35 = (((typeEnvInsert "readFile") (baseScheme (TyFn (tyStr, tyStr)))) e34) in (let e36 = (((typeEnvInsert "writeFile") (baseScheme (TyFn (tyStr, (TyFn (tyStr, tyUnit)))))) e35) in (let e37 = (((typeEnvInsert "fileExists") (baseScheme (TyFn (tyStr, tyBool)))) e36) in (let e38 = (((typeEnvInsert "exit") (baseScheme (TyFn (tyInt, tyUnit)))) e37) in (let e39 = (((typeEnvInsert "getArgs") (baseScheme (tyList tyStr))) e38) in (let e40 = (((typeEnvInsert "listLen") (MkScheme (["$a"], (TyFn ((tyList (TyName "$a")), tyInt))))) e39) in (let e41 = (((typeEnvInsert "listIsEmpty") (MkScheme (["$a"], (TyFn ((tyList (TyName "$a")), tyBool))))) e40) in (let e42 = (((typeEnvInsert "listReverse") (MkScheme (["$a"], (TyFn ((tyList (TyName "$a")), (tyList (TyName "$a"))))))) e41) in (let e43 = (((typeEnvInsert "listAppend") (MkScheme (["$a"], (TyFn ((tyList (TyName "$a")), (TyFn ((tyList (TyName "$a")), (tyList (TyName "$a"))))))))) e42) in (let e44 = (((typeEnvInsert "listConcat") (MkScheme (["$a"], (TyFn ((tyList (tyList (TyName "$a"))), (tyList (TyName "$a"))))))) e43) in (let e45 = (((typeEnvInsert "listHead") (MkScheme (["$a"], (TyFn ((tyList (TyName "$a")), (tyMaybe (TyName "$a"))))))) e44) in (let e46 = (((typeEnvInsert "listTail") (MkScheme (["$a"], (TyFn ((tyList (TyName "$a")), (tyList (TyName "$a"))))))) e45) in (let e47 = (((typeEnvInsert "listAt") (MkScheme (["$a"], (TyFn ((tyList (TyName "$a")), (TyFn (tyInt, (tyMaybe (TyName "$a"))))))))) e46) in (let e48 = (((typeEnvInsert "listMap") (MkScheme (["$a"; "$b"], (TyFn ((TyFn ((TyName "$a"), (TyName "$b"))), (TyFn ((tyList (TyName "$a")), (tyList (TyName "$b"))))))))) e47) in (let e49 = (((typeEnvInsert "listFilter") (MkScheme (["$a"], (TyFn ((TyFn ((TyName "$a"), tyBool)), (TyFn ((tyList (TyName "$a")), (tyList (TyName "$a"))))))))) e48) in (let e50 = (((typeEnvInsert "listFold") (MkScheme (["$a"; "$b"], (TyFn ((TyFn ((TyName "$b"), (TyFn ((TyName "$a"), (TyName "$b"))))), (TyFn ((TyName "$b"), (TyFn ((tyList (TyName "$a")), (TyName "$b")))))))))) e49) in (let e51 = (((typeEnvInsert "maybeMap") (MkScheme (["$a"; "$b"], (TyFn ((TyFn ((TyName "$a"), (TyName "$b"))), (TyFn ((tyMaybe (TyName "$a")), (tyMaybe (TyName "$b"))))))))) e50) in (let e52 = (((typeEnvInsert "maybeBind") (MkScheme (["$a"; "$b"], (TyFn ((TyFn ((TyName "$a"), (tyMaybe (TyName "$b")))), (TyFn ((tyMaybe (TyName "$a")), (tyMaybe (TyName "$b"))))))))) e51) in (let e53 = (((typeEnvInsert "maybeWithDefault") (MkScheme (["$a"], (TyFn ((TyName "$a"), (TyFn ((tyMaybe (TyName "$a")), (TyName "$a")))))))) e52) in (let e54 = (((typeEnvInsert "true") (baseScheme tyBool)) e53) in (let e55 = (((typeEnvInsert "false") (baseScheme tyBool)) e54) in e55))))))))))))))))))))))))))))))))))))))))))))))))))))))))
...
let demo1 =
    (let src = "module Demo\nadd(a Int)(b Int) = a + b\n" in (let result = (compile src) in ((strContains "add") result)))

let demo2 =
    (let src = "module Demo\nresult = unknownName\n" in (let result = (compile src) in ((strContains "Unbound") result)))
...
[<EntryPoint>]
let main (argv: string[]) =
    (let _ = ((checkBool "1 compile produces output") demo1) in (let _ = ((checkBool "2 compile catches unbound") demo2) in (let _ = ((checkBool "3 inference ok on typed") demo3) in (let _ = ((checkBool "4 lookup finds symbol") demo4) in (printfn "Done")))))
    0